...
export default function App() {
    const [listOfItems, setListOfItems] = useState([{text: 'Купить молока', key: '1'}, {
        text: 'Помыть машину', key: '2'
    }, {text: 'Купить картошку', key: '3'}, {text: 'Купить слона', key: '4'},])

    const addHandler = (text) => {
        if (text.trim().length < 5) {
            Alert.alert('Warning', 'Write more than five symbols!');
            return
        }
